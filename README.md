...
**Hello React Frontend** is an implemention of a connection between Ruby on Rails back-end and React front-end. [Hello Rails Backend](https://github.com/myaserkhan/Hello-Rails-Backend) handles the backend API, and [Hello React Frontend](https://github.com/myaserkhan/Hello-React-Frontend) handles the frontend UI to display a random greeting message.
...
```
  git clone git@github.com:myaserkhan/Hello-React-Frontend.git
